...
// var _myName = "abdul";
// var 1myName = "tareq";
// var _1my__Name = "karim";
// var $myName = "tareq technical";
// var myNaem% = "tareq technical";
...
// // 👉 // 🤩 SUBSCRIBE TO tareq TECHNICAL YOUTUBE CHANNEL 🤩
...
// var iAmtareqs = false;
// console.log(iAmtareqs);

// // typeof operator 
// console.log(typeof(iAmtareqs));
...
// console.log(myName + " tareq");
// console.log(myName + " karim");
// console.log(myName + " karim tareq");
...
// function biodata() {
//   const myFirstName = "abdul";
//   console.log(myFirstName);

//   if(true){
//     const myLastName = "tareq";
//   }
...
// or properties from objects, into distinct variables.
  ...
  // const myBioData = ['abdul', 'tareq', 26];
...
// const message = "my name is abdul";
// console.log(message);
...
// var myFriends = ['abdul','ramesh','arjun','vishal'];
...
// var myFriendNames = ["abdul","karim","tareq","tareqtechnical","tareq"];

// console.log(myFriendNames.indexOf("tareq", 3));
...
// console.log(myFriendNames.lastIndexOf("tareq",3));
...
// var myFriendNames = ["abdul","karim","tareq","tareqtechnical"];

// console.log(myFriendNames.includes("tareq"));
...
// let myName = "abdul tareq";
// let myChannelName = 'abdul tareq';

// // let ytName = new String("tareq Technical");
// let ytName = 'tareq technical';
...
// const myBioData =  'I am the tareq Technical';
...
// let myBioData = `I am abdul karim tareq abdul`;

// let repalceData = myBioData.replace('abdul','abdul');
...
// Writing abdul (with upper-case) will not work
...
// if (confirm("Want to Visit tareqTechnical?")) {
//   location.href = "https://www.youtube.com/tareqtechnical"; // redirect the browser to another URL
// }
